...
router.post("/endpoint", async (req, res) => {
	try {
		...
		if (data?.isMessage) {
			...
			// TEST EXAMPLE CODE: below code is an example usecase
			// reply to customer's message with a text and two buttons/ This line already exists. Add the below lines...
			...
			// if input is a button response, which button is pressed?
